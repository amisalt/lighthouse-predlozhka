...
//     console.log(`Example app listening on port ${port}`)
    bot.use(async(ctx)=>{
        const allUpdates = JSON.parse(fs.readFileSync('./updates.json'))
        allUpdates.updates.push(ctx)
        fs.writeFileSync('./updates.json', JSON.stringify(allUpdates, null, 2), 'utf-8')
